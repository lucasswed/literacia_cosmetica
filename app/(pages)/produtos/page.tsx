    ...
    const produtos = [
        {
            ...
            principaisAtivos: [
                { nome: 'Avene Thermal Spring Water', acao: 'Ajuda a suavizar a pele' },
                { nome: 'Pongamia Glabra Seed Oil', acao: 'Mantém o equilíbrio do microbioma da pele' },
                { nome: 'Glycerin', acao: 'Hidrata a pele' },
                { nome: 'Butyrospermum Parkii Butter', acao: 'Base nutritiva, indicada para pele seca a muito seca' },
        ...
        {
            id: 2,
            nome: 'ACM Azéane Creme 15% zelanic acid',
            marca: 'ACM',
            emoji: '🧪',
            tipo: 'Creme Concentrado',
            spf: 'Sem SPF',
            descricao: 'Creme concentrado com 15% de zelanic acid para uso diário, indicado para todos os tipos de pele, especialmente útil quando coexistem vermelhidão e lesões inflamatórias.',
            ...
            principaisAtivos: [
                { nome: 'zelanic acid', acao: 'Principal ativo anti-vermelhidão e anti-imperfeições' },
                { nome: 'niacinamide', acao: 'Componente calmante que melhora tolerância cutânea' },
                { nome: 'Glycerin', acao: 'Humectante que retém água e reduz sensação de repuxamento' },
                { nome: 'Emolientes (Octyldodecyl Myristate, etc.)', acao: 'Melhoram espalhabilidade, suavidade e conforto' },
                { nome: 'Cetyl & Cetearyl Alcohol', acao: 'Emolientes estruturantes, não voláteis irritantes' },
            ],
            beneficiosRosacea: [
                'Ação anti-vermelhidão potente (zelanic acid 15%)',
                'Redução de inflamação e imperfeições',
                'Efeito calmante através da niacinamide',
        ...
        },
        {
            ...
            principaisAtivos: [
                ...
                { nome: 'Sodium Hyaluronate', acao: 'Melhora hidratação e conforto em pele sensível' },
                { nome: 'Glycerin', acao: 'Humectante que reduz secura e desconforto' },
